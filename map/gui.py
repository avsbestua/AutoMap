...
def map_(prompt: str, mode: str, map: str, size_mod: int, optional_feature: str, model: str,
    ...
    threading.Thread(target=auto_map.auto_map,
                     args=(prompt, mode, map, int(size_mod), optional_feature, model, font_name), daemon=True).start()
...
class App(ctk.CTk):
    def __init__(self):
        ...
        ctk.CTkLabel(self, text="Enter prompt for AI", font=("Arial Rounded MT Bold", 14), text_color='#000000').pack(
            pady=(8, 4))
        ...
        ctk.CTkLabel(self, text="AutoMap mode", font=("Arial Rounded MT Bold", 16), text_color='#000000').pack(
            pady=(0, 4))
        ...
        default_map_rd = ctk.CTkRadioButton(map_mode_frame, bg_color='#343434', text="Default", variable=map_var,
                                            value="default", font=("Arial Rounded MT Bold", 12), text_color="#FFFFFF")
        default_map_rd.pack(side='left', padx=8, pady=6)

        flag_map_rd = ctk.CTkRadioButton(map_mode_frame, bg_color='#343434', text="Flag", variable=map_var,
                                         value="flag", font=("Arial Rounded MT Bold", 12), text_color="#FFFFFF")
        flag_map_rd.pack(side='left', padx=8, pady=6)

        world_map_rd = ctk.CTkRadioButton(map_mode_frame, bg_color='#343434', text="World", variable=map_var,
                                          value="world", font=("Arial Rounded MT Bold", 12), text_color="#FFFFFF")
        world_map_rd.pack(side='left', padx=8, pady=6)

        ctk.CTkLabel(self, text="Global Size Modifier", font=("Arial Rounded MT Bold", 14), text_color='#000000').pack(
            pady=(6, 4))
        ...
        none_rd = ctk.CTkRadioButton(options_frame, bg_color='#343434', text="No extra option",
                                     variable=optional_feature_var, value="none", font=("Arial Rounded MT Bold", 10),
                                     text_color="#FFFFFF")
        none_rd.pack(side='left', padx=6, pady=6)

        most_least_rd = ctk.CTkRadioButton(options_frame, bg_color='#343434', text="Show most and least country",
                                           variable=optional_feature_var, value="most_least",
                                           font=("Arial Rounded MT Bold", 10), text_color="#FFFFFF")
        most_least_rd.pack(side='left', padx=6, pady=6)

        short_form_rd = ctk.CTkRadioButton(options_frame, bg_color='#343434', text="Write in short form",
                                           variable=optional_feature_var, value="short_form",
                                           font=("Arial Rounded MT Bold", 10), text_color="#FFFFFF")
        ...
        ctk.CTkLabel(self, text="Select Font", font=("Arial Rounded MT Bold", 14), text_color='#000000').pack(
            pady=(6, 4))

        font_var = ctk.StringVar(value=Path("DIN Condensed.ttf"))

        font_cb = ctk.CTkComboBox(self, width=220, height=26, font=("Arial Rounded MT Bold", 12), variable=font_var,
                                  values=[x.name for x in Path("resources/fonts").iterdir() if x.suffix == '.ttf'])
